...
However, the application does not properly restrict access to the admin panel. At best it is protected by an unpredictable URL, which can be discovered by an attacker.
