...
**Lab**: _Information disclosure in version control history_
...
2. Check for pages sources and `robots.txt` to find the backup files. Possibly also check for `.git` or `.svn` directories.
